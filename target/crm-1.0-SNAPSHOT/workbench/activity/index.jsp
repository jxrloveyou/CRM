...
<script type="text/javascript">
	...
	$(function(){
                    ...
                    if(data) {
                        ...
                        /*
                            注意：
                                ...
                                对于表单的jQuery对象，提供submit（）方法让我们提交表单
                                但是表单的jQuery没有提供reset方法（坑），
                                转为dom对象
                         */
        ...
        $("#search-button").click(function () {
            /*
                点击查询按钮的时候，我们应该将搜索框的信息保存起来，保存到隐藏域中
             */
				...
				<div class="modal-body">
					...
					<form id="activityAddForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" value="" id="create-owner">
								</select>
							</div>
...
<%--
                    ...
                    现在我们是以属性和属性值的方式写在了button元素中，用来打开模态窗口，但存在问题
                        没有办法对按钮的功能进行扩充，所有实际中对于触发模态窗口的操作，一定不要写死在元素当中，
                        应该由我们自己写js代码来操作
--%>
