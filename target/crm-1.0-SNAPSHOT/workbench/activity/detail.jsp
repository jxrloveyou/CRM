	...
	$(function(){
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data.success) {
                        ...
                        html += '<a class="myHref" onclick="editRemark(\'' + data.ar.id + '\')" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #90F790;"></span></a>';
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                        //多态生成的事件的参数必须套在字符串中
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data.success) {
                        // 更新div中相应的信息，需要更新的内容由noteContent，editTime, editBy
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $.each(data, function (i, n) {
                    ...
                    html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                    html += '<a class="myHref" onclick="editRemark(\'' + n.id + '\')" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #90F790;"></span></a>';
                    html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                    //多态生成的事件的参数必须套在字符串中
